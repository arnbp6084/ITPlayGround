            ...
            <a style="float:right;margin:2%;box-shadow: 25px 15px 20px 0px grey;" class=""  href="{{ url('/admincontent/create') }}" title=""><button  type="button" class="btn btn-warning">+ Add content</button></a>
               <table id="responsive1" class="display responsive" style="width:100%;box-shadow: 0px 0px 10px 0px grey;">
                    ...
                    <tbody>
                        ...
                        @endphp
                            @foreach ($contentinfo as $cont)
                              @php
                                $contid=$cont['id'];
                                $conttitle=$cont['title'];
                                $contdesc=$cont['description'];
                            ...
                            <tr>
                                ...
                                <td>
                                    <form id="stsfrm" action="{{url('/admincontentsts')}}" method="POST">
                                ...
                                <td>
                                <a class=""  href="{{ URL::to('admincontent/' . $contid) }}" title=""><button style="box-shadow: 25px 15px 20px 0px grey;" type="button" class="btn btn-warning">View</button></a>

                                <a href="{{ URL::to('admincontent/' . $contid . '/edit') }}">
                                <button style="box-shadow: 25px 15px 20px 0px grey;" type="button" class="btn btn-warning">Edit</button>
                                </a>&nbsp;

                                <form id="dltfrm" action="{{url('admincontent', [$contid])}}" method="POST">
